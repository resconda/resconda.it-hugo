...
L’uso delle microonde come strumento per riscaldare sostanze ha una [storia quasi centenaria](https://en.wikipedia.org/wiki/Microwave_oven#History). La diffusione capillare dei forni a microonde nelle nostre case è senz’altro più recente, ma è comunque diventato uno strumento che molti danno  per scontato.  
...
In [questo articolo](https://ecocostsavings.com/microwave-wattage/) un’analisi fatta su più di 200 forni a microonde ha mostrato un’efficienza media di circa 71%, con picchi anche superiori al 90%. L’energia elettrica effettivamente consumata sarà quindi in media pari a 25,4 Wh.

In assenza del microonde, il naturale rivale per l’operazione di riscaldamento è il fornello a gas. Ripescando [un documento](https://www.aceee.org/files/proceedings/2014/data/papers/9-702.pdf) che abbiamo citato in una [precedente pillola](https://www.resconda.it/articles/gas-elettrico-tradizionale-o-induzione/), sappiamo che l’efficienza dei fornelli a gas si aggira intorno al 40%. Il contatore in questo caso dirà che abbiamo consumato 45 Wh.
...
Non abbiamo ancora potuto provare personalmente, ma dalle indicazioni fornite in [questa ricetta](https://blog.giallozafferano.it/neltegamesulfuoco/ricetta-pasta-pomodoro-microonde/) della pasta al pomodoro sembra che con 7 minuti di cottura a 800 W si possa cuocere una doppia porzione del più famoso piatto della cucina italiana.   
