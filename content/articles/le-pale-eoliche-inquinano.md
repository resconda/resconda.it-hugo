...
Al di là di tutto questa osservazione è assolutamente pertinente ed andrebbe sempre fatta, quando si valuta un investimento in campo ambientale (e non), poiché qualsiasi manufatto ha uno “zaino” energetico e per il solo fatto di essere realizzato rappresenta un danno ambientale. Per questo, ad esempio, {{< locallink href="articles/veicoli-elettrici-quale-impatto-ambientale/">}}l’acquisto di un’auto elettrica{{< /locallink>}} o la {{< locallink href="articles/direttiva-eu-green-house/">}}coibentazione di un edificio{{< /locallink>}} possono anche costituire un danno, dal punto di vista ambientale. Fa quindi bene, in un certo senso, l’autore a puntare il dito contro una visione edulcorata della transizione ecologica, che tende ad ignorare i costi ambientali della transizione.   
