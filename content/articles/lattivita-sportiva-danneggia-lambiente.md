...
Innanzitutto, come si misura l’energia spesa nel fare attività sportiva? C’è una definizione scientifica, il MET (acronimo inglese per [equivalente metabolico di attività](https://it.wikipedia.org/wiki/Equivalente_metabolico_di_attivit%C3%A0)), che è in pratica la misura del consumo di ossigeno di una persona rispetto al consumo standard di una persona a riposo, seduta e in silenzio, che è pari a 3,5 ml per chilogrammo di peso al minuto: 1 MET . In unità di energia a noi familiari, si ha

\[ 1\;\mathrm{MET} = 1\;\mathrm{kcal} / (\mathrm{kg}\cdot \mathrm{h}) = 1.162\;\mathrm{W/kg}\]
...
{{< cloudinary_img src="assets/post-img/ctee_etqcko" caption="Schema dei modelli di spesa energetica totale additiva e di spesa energetica totale vincolata [[fonte](https://www.cell.com/fulltext/S0960-9822%2815%2901577-8#:~:text=Here%20we%20tested,on%20metabolic%20physiology)]." >}}
