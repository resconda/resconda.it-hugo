...
Possiamo quindi sovrastimare una media di 500W per 30 minuti (probabilmente qualcosa meno). Moltiplicato per i 4 *cyclor* arriviamo a 2000W medi in circa 30 minuti di competizione, ovvero ad **una produzione/consumo di energia** per imbarcazione **di un solo kWh.** Nemmeno sufficiente nella nostra vita quotidiana per fare una {{< locallink href="articles/rescoprire-lacqua-calda/">}}doccia calda{{< /locallink>}} (ma abbastanza per cucinare un {{< locallink href="articles/la-pasta-alla-parisi-1/">}}piatto di pasta{{< /locallink>}}). 

Anche questa volta, le impressionanti prestazioni fisiche degli atleti diventano trascurabili (e lo sono…) quando vengono rapportate al mondo dell’energia e dei suoi ordini di grandezza. Un tema, questo, che abbiamo già trattato nella {{< locallink href="articles/autoprodurre-l-elettricita/">}}pillola{{< /locallink>}} di Robert, ciclista di pista professionista che arriva a 600W in lotta contro un tostapane, o in {{< locallink href="articles/teatro-a-pedali/">}}quest’altra{{< /locallink>}} dove si cercava di alimentare eventi culturali con una platea di ciclisti amatoriali. 
